# Changelog — Sovereign Mainframe And Engine
...
- Production implementation of core components: EventJournalMerkle, ProtocolFSM, P2PMessageBus, TaskRouterDAG, RPGSimulationLoop.
